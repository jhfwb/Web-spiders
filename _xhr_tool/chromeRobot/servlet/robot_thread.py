        ...
        while True:
            ...
            if reStartSign==False:
                ...
                if len(item)==0:
                    ...
                    item = ChromeFactory().getPassageway().put(item)
