...
class Aaicaigou:
    ...
    def webInit(self):#初始化
        ...
        Action().scroll_browser_top_to_button().\
    ...
    def webRobot(self):
        ...
        for i in range(self.cycleTimes):
            ...
            click(cssStr='.ivu-page-next').scroll_browser_top_to_button(cssStr='.ivu-page-item',elemntName='1',timeOut=60).excuteBlock()
            tool().print('开始运行下一页....')
    ...
    # @chrome_robot_excute
    def test(self):
        Action().scroll_browser_top_to_button(csstr='.ivu-page-item',elemntName='2').excute()
