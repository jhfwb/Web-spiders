...
class MultiValueDictKeyError(KeyError):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "scrapy._utils.datatypes.MultiValueDictKeyError is deprecated "
...
class MultiValueDict(dict):
    ...
    def __init__(self, key_to_list_mapping=()):
        warnings.warn("scrapy._utils.datatypes.MultiValueDict is deprecated "
                      "and will be removed in future releases.",
                      category=ScrapyDeprecationWarning,
                      stacklevel=2)
...
class SiteNode(object):
    ...
    def __init__(self, url):
        warnings.warn(
            "scrapy._utils.datatypes.SiteNode is deprecated "
            "and will be removed in future releases.",
            category=ScrapyDeprecationWarning,
            stacklevel=2
        )
...
class MergeDict(object):
    ...
    def __init__(self, *dicts):
        if not six.PY2:
            warnings.warn(
                "scrapy._utils.datatypes.MergeDict is deprecated in favor "
