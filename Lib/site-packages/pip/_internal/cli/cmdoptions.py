...
src = partial(
    Option,
    '--webScrapySystem', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    metavar='dir',
    default=get_src_prefix(),
    help='Directory to check out editable projects into. '
    'The default in a virtualenv is "<venv path>/webScrapySystem". '
    'The default for global installs is "<current dir>/webScrapySystem".'
)  # type: Callable[..., Option]
