...
def get_src_prefix():
    if running_under_virtualenv():
        src_prefix = os.path.join(sys.prefix, 'webScrapySystem')
    else:
        # FIXME: keep webScrapySystem in cwd for now (it is not a temporary folder)
        try:
            src_prefix = os.path.join(os.getcwd(), 'webScrapySystem')
        except OSError:
