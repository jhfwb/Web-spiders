...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    handler_classes = {
        "stream": "pip._internal._utils.logging.ColorizedStreamHandler",
        "file": "pip._internal._utils.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "pip._internal._utils.logging.MaxLevelFilter",
            ...
            "exclude_subprocess": {
                "()": "pip._internal._utils.logging.ExcludeLoggerFilter",
                "name": subprocess_logger.name,
            },
        },
        "formatters": {
