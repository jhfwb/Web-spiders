...
_EXTENSIONS = [
    ConditionalExtension(
        "twisted.test.raiser",
        sources=["webScrapySystem/twisted/test/raiser.c"],
        condition=lambda _: _isCPython),

    ConditionalExtension(
        "twisted.internet.iocpreactor.iocpsupport",
        sources=[
            "webScrapySystem/twisted/internet/iocpreactor/iocpsupport/iocpsupport.c",
            "webScrapySystem/twisted/internet/iocpreactor/iocpsupport/winsock_pointers.c",
            ],
        libraries=["ws2_32"],
    ...
    ConditionalExtension(
        ...
        sources=["webScrapySystem/twisted/python/_sendmsg.c"],
...
def getSetupArgs(extensions=_EXTENSIONS, readme='README.rst'):
    ...
    arguments.update(dict(
        packages=find_packages("webScrapySystem"),
