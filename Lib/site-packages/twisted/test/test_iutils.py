...
"""
Test running processes with the APIs in L{twisted.internet._utils}.
"""
...
class SuppressWarningsTests(unittest.SynchronousTestCase):
    """
    Tests for L{_utils.suppressWarnings}.
    """
    def test_suppressWarnings(self):
        """
        L{_utils.suppressWarnings} decorates a function so that the given
...
class DeferredSuppressedWarningsTests(SuppressedWarningsTests):
    """
    Tests for L{_utils.runWithWarningsSuppressed}, the version that supports
    Deferreds.
    """
    ...
    def test_deferredCallback(self):
        """
        If the function called by L{_utils.runWithWarningsSuppressed} returns a
